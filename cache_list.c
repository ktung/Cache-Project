...
void Cache_List_Append(struct Cache_List *list, struct Cache_Block_Header *pbh) {
	...
	// Déplacement du pointeur jusqu'au bout
	...
	// Création de la Cache_List à ajouter
	struct Cache_List *cache_list_to_add = Cache_List_Create();
...
{
	struct Cache_Block_Header *datas = list->pheader;
...
{
	struct Cache_Block_Header *datas;
	struct Cache_List *temp = list, *beforeLast;
...
{
	struct Cache_List *temp = list, *before;
	struct Cache_Block_Header *datas = NULL;
